...
def main():
    ...
    # better_draw_circles(rg.Point(3, 36), 7)
    # better_draw_circles(rg.Point(4, 45), 6)
    # even_better_draw_circles(rg.Point(2,7), 4, 5, 'red', 5)
    even_even_better_draw_circles(rg.Point(0,0), 2, 50, 'magenta', 1)
    draw_some_dang_circles(rg.Point(2,3), 4, 70, 'cyan', 2)
    window.update()
...
###############################################################################
def even_even_better_draw_circles(point,radius,number,color,thickness):
    ...
    for k in range(number):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen.color = color
        turtle.thickness = thickness
def draw_some_dang_circles(point, radius, number, color, thickness):
    turtle = rg.SimpleTurtle('turtle')
    turtle.pen_up()
    turtle.go_to(point)
    turtle.set_heading(0)  # Point "east" (towards the right)
